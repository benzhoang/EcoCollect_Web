                                ...
                                <div className="relative" ref={userMenuRef}>
                                    ...
                                    {isUserMenuOpen && (
                                        <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                                            ...
                                            <a href="/statistics" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors" onClick={() => setIsUserMenuOpen(false)}>Thống kê</a>
                    ...
                    <div className="md:hidden border-t border-gray-200 py-4 space-y-2">
                        ...
                        {isLoggedIn ? (
                            <div className="pt-4 space-y-2 border-t border-gray-200">
                                ...
                                <a href="/statistics" className="block px-4 py-2 text-gray-700 font-medium rounded-lg hover:bg-green-50 hover:text-green-700 transition-all duration-200" onClick={() => setIsMenuOpen(false)}>Thống kê</a>
